...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # ===== ডেইলি রিলিজ সব দেখুন =====
    elif data == "daily_all":
        text = "📋 **সব ডেইলি রিলিজ**\n\n"
        
        if daily_release_db["entries"]:
            for entry in daily_release_db["entries"][-10:]:  # শেষ ১০টা
    ...
    # ===== ব্যাকআপ রিস্টোর =====
        ...
        text += "কোন ব্যাকআপ রিস্টোর করতে চান?\n\n"
